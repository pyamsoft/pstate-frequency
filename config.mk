...
## Linker Flags
LDFLAGS:= -Wl,-O3,--sort-common,--as-needed,-z,relro,-z,now,--strip-all ${LIBS}

## Compiler flags
CFLAGS:= -DWRITE_MSR=${WRITE_MSR} -DVERSION=\"${VERSION}[${CC}]\" \
	 -DINCLUDE_UDEV_RULE=${INCLUDE_UDEV_RULE} ${STD} -O3 -Wall \
	 -march=native -mtune=generic -pipe -fstack-protector-strong \
	 --param=ssp-buffer-size=4 \
	 -Wextra -Werror -Wmissing-prototypes -Wunreachable-code ${INCS}
